...
export const ENUM_META: Partial<Record<AllEnums, Meta>> = {
  ...
  OILS: { label: "Oils", color: "bg-yellow-100 text-yellow-800" },
  BAKERY: { label: "Bakery", color: "bg-pink-100 text-pink-700" },
  PRODUCE: { label: "Produce", color: "bg-green-100 text-green-700" },

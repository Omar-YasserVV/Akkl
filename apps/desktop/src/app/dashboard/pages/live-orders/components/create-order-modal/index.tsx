...
const CreateOrderModal = () => {
  ...
  const handleCreateOrder = () => {
    ...
    const totalItems = newOrderDraft.items.reduce(
  ...
  return (
    ...
    >
      <ModalContent className="rounded-lg shadow-xl">
        ...
        <ModalBody className="py-6 px-6 space-y-6">
          ...
          <div className="space-y-4">
            {newOrderDraft.items.map((item, index) => (
              <div
                key={item.id}
                className="rounded-lg border border-gray-100 bg-card overflow-hidden transition-all duration-200 hover:border-gray-200"
              >
                ...
                <div className="px-5 py-5 space-y-4 bg-white">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      value={item.notes}
                      onValueChange={(val) =>
                        updateDraftItem(item.id, "notes", val)
                      }
                      classNames={{
                        inputWrapper:
          ...
          <Button
            ...
            className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-xl border-2 border-dashed border-default-300 bg-card min-h-20 text-sm text-default-400 hover:bg-gray-100/50 hover:border-default-300 transition-all duration-200 "
          >
        ...
        <ModalFooter className="px-6 py-6 border-t border-gray-100 gap-3 items-center">
          <Button
            variant="bordered"
            radius="sm"
          ...
          <Button
            color="primary"
            radius="sm"
            className="bg-primary text-white text-md px-6 py-5"

...
const LiveOrdersHeader = () => {
    ...
    const [selectedFilesLabel, setSelectedFilesLabel] = React.useState<string>("Upload file");
    ...
    return (
        <header className="flex justify-between items-end">
            ...
            <Button onPress={onOpen} className="bg-primary rounded-lg px-3 text-white py-3"><Plus />New Order</Button>
            <Modal
                isOpen={isOpen}
                    ...
                    {(onClose: () => void) => (
                        <>
                            ...
                            <ModalBody className="py-4 space-y-5">
                                ...
                                <div className="rounded-xl border border-gray-200 bg-gray-50 overflow-hidden">
                                    ...
                                    <div className="px-4 py-4 space-y-4 bg-white">
                                        ...
                                        <div className="space-y-1">
                                            <p className="text-sm font-semibold text-gray-900">Special Notes</p>
                                            <Textarea
                                ...
                                <div className="mt-1">
                                    <input
                                        ...
                                        onChange={(e) => {
                                            ...
                                            if (files.length === 1) {
                                                setSelectedFilesLabel(files[0]?.name ?? "1 file selected");
                                                return;
                                            }
                            ...
                            <ModalFooter className="pt-2">
                                <Button variant="flat" radius="sm" className="bg-white" onPress={onClose}>
                                    Cancel
                                </Button>

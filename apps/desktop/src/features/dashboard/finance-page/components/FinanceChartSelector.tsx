...
import { LuShoppingCart, LuTrendingDown } from "react-icons/lu";
import { AnalyticsRecord } from "../../overview/types/analytics";
...
const FinanceChartSelector = ({
  ...
  const icons = [FaDollarSign, LuShoppingCart, LuTrendingDown];

        ...
        <div className="flex items-center gap-3">
          ...
          <Tooltip color="danger" content="Delete">
            <button
              ...
              disabled={isDeleting}
              type="button"
              className="h-9 w-9 rounded-sm border border-gray-100 bg-white text-rose-500 inline-flex items-center justify-center hover:bg-rose-50 disabled:opacity-50"
            >
              {isDeleting ? (
